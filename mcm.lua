...
function this.registerModConfig()
    ...
    do
        ...
        compatibilityPage:createYesNoButton{label = "Set high priority for the mod's actions", restartRequired = true, config = config.data.misc, configKey = "highPriority"}
        createLabel{self = compatibilityPage, label = ""}

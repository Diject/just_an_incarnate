...
local fileSys = include("diject.just_an_incarnate.utils.fileSys")
...
local deathMapDir = tes3.installDirectory.."\\Data Files\\MWSE\\mods\\diject\\just_an_incarnate\\map\\"
...
---@param cell tes3cell
---@return jai.storage.deathMapRecord
local function serializeActor(playerId, actor, cell, position, orientation, deathCount)
    ...
    ---@type jai.storage.deathMapRecord
    local out = {
        playerId = playerId,
        recordId = os.time(),
...
---@param record jai.storage.deathMapRecord
---@param cell tes3cell
---@param playerId string
...
---@param path string
---@return jai.storage.deathMapRecord|nil
